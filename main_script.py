...
local_db_creds = db_connect.read_local_db_creds()
...
user_data_upload = upload.upload_to_db(upload_engine, cleaned_user_data, "dim_users")
pdf_data_upload = upload.upload_to_db(upload_engine,cleaned_pdf_data,"dim_card_details")
store_data_upload = upload.upload_to_db(upload_engine,cleaned_store_data, "dim_store_details")
product_data_upload = upload.upload_to_db(upload_engine,cleaned_product_data,"dim_products")
